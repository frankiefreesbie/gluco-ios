-- Final fix for foreign key constraints
-- This addresses the exact constraint names from the error message
...
-- Now drop the problematic constraints
...
-- Recreate with proper CASCADE DELETE
ALTER TABLE preparation_steps 
