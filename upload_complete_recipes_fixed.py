#!/usr/bin/env python3
"""
Upload Complete Recipes Script (Fixed)
...
def main():
    ...
    # Recipe data with exact database names (excluding Grilled Chicken and Toast with Savory Jam)
    recipes_data = [
        {
        ...
        {
            "name": "Quiche with peas and cheese",
            "prep_time": 15,
